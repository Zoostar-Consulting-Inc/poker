...
public class ClientTest {
    ...
    private static final String CA_URI = "https://acme-staging-v02.api.letsencrypt.org/directory";

    // E-Mail address to be associated with the account. Optional, null if not used.
    private static final String ACCOUNT_EMAIL = "devops@zoostar.net";
    ...
    private static final File USER_KEY_FILE = new File("C:\\Users\\pratik\\.identity\\poker.pem");

    // File name of the Domain Key Pair
    private static final File DOMAIN_KEY_FILE = new File("C:\\Users\\pratik\\.identity\\apigator.pem");

    // File name of the signed certificate
    private static final File DOMAIN_CHAIN_FILE = new File("C:\\Users\\pratik\\.identity\\apigator.crt");
